...
const WeatherCard = ({weatherElement,moment,fetchData,handleCurrentPageChange,cityName}) => {
    const { observationTime, description, windSpeed, temperature, rainPossibility, isLoading,comfortability,weatherCode, } = weatherElement;
    return (
        <WeatherCardWrapper>
            ...
            <Refresh onClick={fetchData} isLoading={isLoading}>最後觀測時間 : {new Intl.DateTimeFormat('zh-TW', {
                hour: 'numeric',
                minute: 'numeric'
